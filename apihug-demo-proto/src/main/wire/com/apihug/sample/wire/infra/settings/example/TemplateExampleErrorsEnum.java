...
@ProtoFrom(
    value = "com/apihug/sample/proto/infra/settings/example/error.proto",
...
public enum TemplateExampleErrorsEnum implements Errors {
  ...
  public static final Error UNDEFINED = Error.unknown().setDomain("sample").setTitle("UNDEFINED");
  ...
  static {
    ...
    THIS_IS_WRONG.setDomain("sample");
